        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 24, marginBottom: 48 }}>
          <div style={{ background: "var(--bg-card)", borderRadius: 16, padding: 28, boxShadow: "0 4px 20px rgba(0,0,0,0.06)" }}>
            ...
            <p style={{ fontSize: 14, color: "var(--text-secondary)", lineHeight: 1.7 }}>
              {t("To provide accessible, affordable, and high-quality higher education that prepares students to become competent professionals and responsible citizens in a global society.")}
            </p>
          </div>
          <div style={{ background: "var(--bg-card)", borderRadius: 16, padding: 28, boxShadow: "0 4px 20px rgba(0,0,0,0.06)" }}>
            <h3 style={{ fontSize: 18, fontWeight: 600, color: "#2563eb", marginBottom: 12 }}>{t("Our Vision")}</h3>
            <p style={{ fontSize: 14, color: "var(--text-secondary)", lineHeight: 1.7 }}>
              {t("To be a leading university in the region, recognized for academic excellence, research innovation, and community engagement.")}
            </p>
          </div>
        </div>
        ...
        <div style={{ background: "var(--bg-card)", borderRadius: 16, padding: 32, boxShadow: "0 4px 20px rgba(0,0,0,0.06)" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16 }}>
            {[
              ...
              ["💻", t("Modern Facilities"), t("State-of-the-art labs, libraries, and online resources.")],
              ["🏆", t("Accredited Programs"), t("All programs are recognized by the Ministry of Education.")],
            ].map(([icon, title, desc]) => (
