  ...
  return (
    <div className="err-page">
      <style>{`
        ...
        .err-blob-1 { width: 360px; height: 360px; background: #D2483C; top: -110px; left: -80px; opacity: 0.16; }
        .err-blob-2 { width: 320px; height: 320px; background: #3E5EDB; bottom: -100px; right: -60px; opacity: 0.22; }
        .err-content { position: relative; z-index: 1; }
        .err-code {
          font-size: 140px; font-weight: 900; line-height: 1; letter-spacing: -0.04em;
          background: linear-gradient(135deg,#D2483C,#E88A3A); -webkit-background-clip: text;
      ...
      <div className="err-content">
        <div className="err-code">403</div>
        <h1 className="err-title">{t("accessForbidden")}</h1>
        <p className="err-desc">{t("accessForbiddenDesc")}</p>
