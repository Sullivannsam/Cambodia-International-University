                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8 lg:gap-12">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="flex flex-wrap gap-3 pt-2">
                            {/* Facebook */}
                            <a href="#" className="text-gray-400 hover:text-blue-600 transition-colors duration-200" aria-label="Facebook">
                                <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 24 24">
                                    <path d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" />
                                </svg>
                            </a>
                            {/* Twitter / X */}
                            <a href="#" className="text-gray-400 hover:text-blue-600 transition-colors duration-200" aria-label="Twitter">
                                <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 24 24">
                            ...
                            {/* Instagram */}
                            <a href="#" className="text-gray-400 hover:text-blue-600 transition-colors duration-200" aria-label="Instagram">
                                <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 24 24">
                            ...
                            {/* GitHub */}
                            <a href="https://github.com" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-[#24292e] transition-colors duration-200" aria-label="GitHub">
                                <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 24 24">
                            ...
                            {/* TikTok */}
                            <a href="https://tiktok.com" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-[#000000] transition-colors duration-200" aria-label="TikTok">
                                <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 24 24">
                            ...
                            {/* Telegram */}
                            <a href="https://t.me" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-[#0088cc] transition-colors duration-200" aria-label="Telegram">
                                <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="pt-2 space-y-2 border-t border-gray-100">
                            ...
                            <div className="flex items-center space-x-2 text-xs text-gray-500">
                                ...
                                <a href="mailto:info@ciu.edu.kh" className="hover:text-blue-600 transition">Mr.Sal@gmail.com.kh</a>
                            </div>
                            <div className="flex items-center space-x-2 text-xs text-gray-500">
